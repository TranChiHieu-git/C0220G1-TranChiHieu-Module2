...
--
-- Host: localhost    Database: serum_car
-- ------------------------------------------------------
...
CREATE TABLE `customers` (
  ...
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`)
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`),
...
-- Dump completed on 2020-04-27 16:41:37
