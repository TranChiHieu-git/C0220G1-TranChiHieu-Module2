...
public class MyLinkedListTest {
    public static void main(String[] args) {
        ...
        System.out.println("Phan tu bi xoa khoi mang la: " + myLinkedList.removeIndex(6));
        myLinkedList.printList();
        System.out.println();
        System.out.println(myLinkedList.removeValue(50));
        System.out.println(myLinkedList.removeValue(500));
        ...
        cloneList.printList();
        System.out.println();
        System.out.println("gia tri 15 co nam trong linkedlist? " + myLinkedList.contains(15));
