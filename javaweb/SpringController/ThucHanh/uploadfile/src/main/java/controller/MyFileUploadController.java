...
public class MyFileUploadController {
    ...
    public String uploadOneFileHandlerPOST(HttpServletRequest request, Model model, @ModelAttribute MyUploadForm myUploadForm) {
    ...
    public String uploadMultiFileHandlerPOST(HttpServletRequest request, Model model, @ModelAttribute MyUploadForm myUploadForm) {
        return this.doUpload(request, model, myUploadForm);
    }
